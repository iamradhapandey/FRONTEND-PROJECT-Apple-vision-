...
var video = document.querySelector("#page7 video");
var img = document.querySelector("#page7 img");
...
btnplay.addEventListener("click", function() {
  if (video.paused){
    video.play();
   btnplay.innerHTML = "<i class='ri-pause-circle-line'></i>";
   img.style.display = "none";

  }
  else{
    video.pause();
    btnplay.innerHTML = "<i class='ri-play-circle-line'></i>";
...
var video1 = document.querySelector("#page10 video");
var img1 = document.querySelector("#page10 img");
var btnplay1 = document.querySelector(".btn-play1");


btnplay1.addEventListener("click", function() {
  if (video1.paused){
    video1.play();
   btnplay1.innerHTML = "<i class='ri-pause-circle-line'></i>";
   img1.style.display = "none";

  }
  else{
    video1.pause();
    btnplay1.innerHTML = "<i class='ri-play-circle-line'></i>";
